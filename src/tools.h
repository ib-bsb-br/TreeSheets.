...
#define TS_PROFILE_SCOPE_CONCAT_IMPL(a, b) a##b
#define TS_PROFILE_SCOPE_CONCAT(a, b) TS_PROFILE_SCOPE_CONCAT_IMPL(a, b)
#define TS_PROFILE_SCOPE(label) TSProfileScope TS_PROFILE_SCOPE_CONCAT(ts_profile_scope_, __COUNTER__)(label)
#else
